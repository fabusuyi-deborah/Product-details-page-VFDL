      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-center">
          <ProductInfo
            ...
            colors={[{ name: 'Royal Brown', value: 'royal-brown', hex: '#B5A99D' }, { name: 'Olive Green', value: 'olive-green', hex: '#708238' }, { name: 'Navy Blue', value: 'navy-blue', hex: '#1D3557' }, { name: 'Charcoal Gray', value: 'charcoal-gray', hex: '#4A4A4A' }]}
